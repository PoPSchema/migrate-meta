...
define('POP_META_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_META_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Meta', 'pop-meta'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-meta')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-meta'),
            'https://github.com/leoloso/PoP',
            POP_META_POP_ENGINE_MIN_VERSION
        );
    }
